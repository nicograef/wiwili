(function (d3) {
    ...
    ***************************************************************************** */
     ...
     */
    function getDataUrl(lastNDays) {
        if (lastNDays === void 0) { lastNDays = 1; }
        var baseUrl = 'https://www.eco-visio.net/api/aladdin/1.0.0/pbl/publicwebpage/data/100004595?';
        var hardParams = '&step=4&domain=751&withNull=true&t=1dc232c11d5617076e9ae7add6e6140128067d38b986e7c9c9da41bb95c41a5b';
        var now = new Date();
        var today = dateToQueryParamDate(now);
        var timeDiffToStartDate = (24 * 60 * 60 * 1000) * lastNDays;
        var startDayDate = new Date(now.getTime() - timeDiffToStartDate);
        var startDate = dateToQueryParamDate(startDayDate);
        var timeRangeParams = "begin=" + startDate + "&end=" + today;
        return baseUrl + timeRangeParams + hardParams;
    }
    function dateToQueryParamDate(date) {
     ...
     * @param {number} lastDays Fetch data from the last n days
     */
    function fetchData(lastNDays) {
        if (lastNDays === void 0) { lastNDays = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var dataUrl;
            return __generator(this, function (_a) {
                console.log('fetching new data ...');
                dataUrl = getDataUrl(lastNDays);
                return [2 /*return*/, axios$1.get(dataUrl).then(function (res) { return res.data; })];
            });
        });
    }
